...
class CNN_ablation(nn.Module):
    def __init__(self, k_frames, input_dim, embed_dim, hidden_dim, num_layers, output_dim, batch_size, device,
                 ablation="None", init_params=True):
        super(CNN_ablation, self).__init__()
        ...
        self.fc_pooling = nn.Linear(k_frames * embed_dim, embed_dim, bias=True)

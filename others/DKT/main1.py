...
def main():
    ...
    train_q_data, train_q_t_data, train_answer_data = dat.prepare_model_data(train_data_path, max_q_id)
    ...
    valid_q_data, valid_q_t_data, valid_answer_data = dat.prepare_model_data(valid_data_path, max_q_id)
